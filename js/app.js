...
const peliculas = [
  ...
  },
  {
    ...
    description: "Película romántica estadounidense dirigida por Garry Marshall y estrenada en 1990.",
    released: true,
...
function cargarPeliculasPorCategoria(categoria, elementoActivo, elementoCarrusel) {
  ...
  for (let i = 0; i < listaPeliculas.length; i++) {
    ...
    } else if (pelicula.released && pelicula.categoria.some((cat) => cat.toLowerCase() === categoria.toLowerCase())) {
